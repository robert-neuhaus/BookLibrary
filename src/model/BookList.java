	...
	public static BookList getInstance() {
		if (instance == null) {
			...
			books.add(new Book(0, "The Plunger", 
					...
					+ "in this thrilling crime drama.", 2018, "123456780", LocalDateTime.now()));
			books.add(new Book(1, "Rise of the Necromancer", 
					...
					+ "in this thrilling crime drama.", 2018, "123456781", LocalDateTime.now()));
			books.add(new Book(2, "Moby Dick", 
					"Moby Dick is back at it again, moby-dicking his way to the top of the charts "
					+ "in this thrilling crime drama.", 1851, "123456782", LocalDateTime.now()));
